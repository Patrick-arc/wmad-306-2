...
Route::get('/insert-user', function () {
    $user = User::create([
        'name' => 'kelvin pogi ' . rand(1, 100000),
        'email' => 'kelvin.sigue' . rand(1, 10000) . '@example.com',
...
Route::get('/test-email', function () {
    ...
    Mail::raw("Welcome to the app, {$user->name}! This is a test email sent by kelvin kelvin.", function ($message) use ($user) {
