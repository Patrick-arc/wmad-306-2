...
const AuthenticatedLayout = ({ header, children }) => {
    ...
    const menuItems = [
        { text: 'Dashboard', href: route('dashboard'), icon: <TrendingUp /> },
        { text: 'Projects', href: route('projects.index'), icon: <TrendingUp /> },
        { text: 'Tasks', href: route('tasks.index'), icon: <TrendingUp /> },
    ];
