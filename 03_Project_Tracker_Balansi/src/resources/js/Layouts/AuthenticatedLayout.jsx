...
import { Link, router } from '@inertiajs/react'; // Added 'router' import
import { 
    AppBar, Toolbar, Box, Typography, IconButton, Menu, MenuItem, 
    Avatar, Button, Container, useTheme, Drawer, List, ListItem, 
...
export default function Authenticated({ user, header, children }) {
    ...
    // FIX: Use router.post for reliable logout
    const handleLogout = () => {
        handleMenuClose();
        ...
        <Box sx={{ minHeight: '100vh', backgroundColor: '#f5f5f7' }}> 
                    ...
                    <Toolbar disableGutters sx={{ justifyContent: 'space-between', height: 64 }}>
                        ...
                        <Box>
                            ...
                            >
                                ...
                                {/* FIX: Using onClick handler instead of Link component */}
            ...
            >
                <Box sx={{ p: 3, display: 'flex', alignItems: 'center', gap: 2 }}>
                    ...
                    <Typography variant="h6" fontWeight="800">TaskFlow</Typography>
                </Box>
                <Divider />
                <List sx={{ px: 2, py: 2 }}>
                    {navLinks.map((link) => (
